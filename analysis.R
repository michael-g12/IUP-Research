...
filestring = sprintf("/Users/Michael/Documents/Data/Transform Comparisons/%s.xlsx", levels(data$Metric)[k])
...
write = rbind(names, pvalues)
filestring = sprintf("/Users/Michael/Documents/Data/Detail Comparisons/%s.xlsx", levels(data$Metric)[k])
write.xlsx(t(write),filestring)
...
filestring = sprintf("/Users/Michael/Documents/Data/Approximate Comparisons/%s.xlsx", levels(data$Metric)[k])
write.xlsx(t(write),filestring)
